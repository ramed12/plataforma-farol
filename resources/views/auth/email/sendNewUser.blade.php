                          ...
                          <table role='presentation' style='width:702px;' cellspacing='0' cellpadding='0' border='0'>
                            <tr>
                              ...
                              <img width='200' src='{!! asset('assets/fundo-auth.png') !!}'><Br><BR>
                                <h1 style='font-size:22px;margin:0 0 20px 0;font-family:Arial,sans-serif;'>Cadastro Pendente de  <b> ativação  </b></h1>
                                <p style='margin:0 0 12px 0;font-size:14px;line-height:24px;font-family:Arial,sans-serif;'>Olá <b>{!! $user->name !!}</b>, Tudo bem?</p>
                                <p style='margin:0 0 12px 0;font-size:14px;line-height:24px;font-family:Arial,sans-serif;'>Bem vindo a plataforma FAROL. Para dar início na efetivação do cadastro, clique <a href='{!! route('auth.register', $user->newRegister) !!}'>AQUI</a> para preencher as informações pendentes</p>
                                <p style='margin:0 0 12px 0;font-size:14px;line-height:24px;font-family:Arial,sans-serif;'>Você só poderá logar no sistema após a efetivação do cadastro.</p>
                                </td>
                            </tr>
                          </table>
                        </td>
