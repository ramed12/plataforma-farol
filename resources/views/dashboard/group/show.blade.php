...
<div class="container-fluid relative animatedParent animateOnce">
    <div class="animated fadeInUpShort">
        <div class="row my-3">
            <div class="col-md-12">
                <form action="{!! route('dash.groupuser.store') !!}" method="POST">
                    <div class="card no-b  no-r">
                        <div class="card-body">
                            <h5 class="card-title">Cadastrar novo Grupo <i class="icon  icon-group_add s-28"></i></h5>
                            <hr>
                           ...
                           @csrf
                            <div class="form-row mt-1">
                                ...
                                <div class="form-group col-12 m-0">
                                    <label for="users" class="col-form-label s-12"><i class=" icon-group_add s-28 mr-2"></i>Usuários </label>
                                    <select name="users[]" class="js-example-basic-multiple"  multiple="multiple">
                        ...
                        <div class="card-body">
                            <button type="submit" class="btn btn-primary btn-lg"><i class="icon-save mr-2"></i>Salvar Grupo</button>
                        </div>
                    </form>
                    </div>
                @include('alert')
